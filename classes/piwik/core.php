 ...
 * @category      Libraries
 * @author        Maxim Razumeyko < max@senta.pro >
...
class Piwik_Core {
    ...
    public static function code()
    {
        ...
        $piwik_url_ssl = Kohana::$config->load('piwik/url_ssl');
        $site_id = $piwik->site_id;
    ...
    function __construct()
    {
        ...
        $this->piwik_url = Kohana::$config->load('piwik/url');
        $this->site_id = Kohana::$config->load('piwik/site_id');
        $this->token = Kohana::$config->load('piwik/token');
        $this->geoip_on = Kohana::$config->load('piwik/geoip_on');
    ...
    public function instance()
    {
        ...
        {
            // Create a new piwik instance
            self::$instance = new Piwik;
        }
